...
jest.mock('lucide-react', () => ({
  Home: (props: any) => <div data-testid="home-icon" {...props}>Home</div>,
  MapPin: (props: any) => <div data-testid="mappin-icon" {...props}>MapPin</div>,
  History: (props: any) => <div data-testid="history-icon" {...props}>History</div>,
